...
| [conflict-resolution](conflict-resolution/spec.md) | Semantic conflict detection after git pull, dedicated Conflict-resolver agent, developer interview | Active |
| [context-priming](context-priming/spec.md) | Primer architecture, `cx context` command, mode-based loading and distillation | Active |
...
| [orchestration](orchestration/spec.md) | Agent hierarchy (Master, Primer, Scout, Supervisor, Contractor, Workers), dispatch strategies, skill mapping | Active |
| [scenarios](scenarios/spec.md) | Given/When/Then scenario format for optional `scenarios.md` files | Active |
| [scout](scout/spec.md) | Read-only codebase exploration agent, direct and team dispatch modes | Active |
